...
verloren = (mixer.Sound("Sounds/Mitteilungen/Spielerrotscheidetaus.mp3"),mixer.Sound("Sounds/Mitteilungen/Spielergelbscheidetaus.mp3"),mixer.Sound("Sounds/Mitteilungen/Spielerblauscheidetaus.mp3"),mixer.Sound("Sounds/Mitteilungen/Spielergrünscheidetaus.mp3"))
letzter = (mixer.Sound("Sounds/Mitteilungen/rotletzter.mp3"),mixer.Sound("Sounds/Mitteilungen/gelbletzter.mp3"),mixer.Sound("Sounds/Mitteilungen/blauletzter.mp3"),mixer.Sound("Sounds/Mitteilungen/grünletzter.mp3"))
zuende = mixer.Sound("Sounds/Mitteilungen/spielzuende.mp3")